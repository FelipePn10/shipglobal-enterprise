...
export default function BusinessImportingPage() {
  ...
  const testimonials = [
    {
      quote:
        "Global Reach has transformed our supply chain. We're now able to source products from international suppliers with minimal hassle and competitive shipping rates.",
      author: "Robert M.",
  ...
  const comparisonData = {
    headers: ["Features", "Traditional Importing", "With Global Reach"],
    rows: [
    ...
    >
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-indigo-300 via-white/90 to-rose-300">
              Traditional Importing vs. Global Reach
            </h2>
