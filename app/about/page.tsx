...
export default function AboutPage() {
  ...
  const milestones = [
    {
      ...
      description:
        "Redirex Solutions was established with a vision to break down international shopping barriers.",
    },
    {
      year: "2017",
  ...
  const team = [
    {
      ...
      bio: "With over 15 years in international logistics, Alexandra founded Redirex to revolutionize cross-border shopping.",
    },
    {
      name: "Marcus Johnson",
  ...
  return (
    <main className="bg-[#030303] text-white">
      <PageHeader title="About Us" subtitle="Our story, mission, and the team behind Redirex" />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-white/70 mb-6 leading-relaxed">
                Redirex Solutions was founded in 2015 with a simple yet powerful vision: to break down the barriers
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <p className="text-white/70 max-w-2xl mx-auto">
                  ...
                  expanded their horizons with Redirex.
                </p>
              </motion.div>
